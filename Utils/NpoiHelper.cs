...
namespace M.Core.Utils
{
    ...
    public class NPOIHelper
    {
        ...
        #endregion
        readonly Color LevelOneColor = Color.Green;
        readonly Color LevelTwoColor = Color.FromArgb(201, 217, 243);
        readonly Color LevelThreeColor = Color.FromArgb(231, 238, 248);
        readonly Color LevelFourColor = Color.FromArgb(232, 230, 231);
        readonly Color LevelFiveColor = Color.FromArgb(250, 252, 213);
