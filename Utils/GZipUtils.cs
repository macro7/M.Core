...
namespace M.Core.Utils
{
    ...
    public class GZipUtils
    {
        ...
        public static byte[] ObjectToGZip(object obj)
        {
            ...
            return GZipUtils.Compress(byteTempArray);
        }
        ...
        {
            byte[] byteTempArray = GZipUtils.Decompress(byteArray);
        ...
        public static void CompressRAR(string sourcePatch, string rarPatch, string rarName)
        {
            string the_rar;
            RegistryKey the_Reg;
            object the_Obj;
            ...
            try
            {
                ...
                if (the_Reg == null)
                {
                    throw new Exception("没有安装WinRAR.exe");
                }
                the_Obj = the_Reg.GetValue("");
                the_rar = the_Obj.ToString();
                the_Reg.Close();
                the_rar = the_rar.Substring(1, the_rar.Length - 7);
                Directory.CreateDirectory(sourcePatch);
                //命令参数
                //the_Info = " a    " + rarName + " " + @"C:Test?70821.txt"; //文件压缩
                the_Info = " a    " + rarName + " " + sourcePatch + " -r"; ;
