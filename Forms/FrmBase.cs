...
namespace M.Core.Forms
{
    ...
    public partial class FrmBase : Form
    {
        ...
        public void SetWindowRegion()
        {
            ...
            path = GetRoundedRectPath(rect, _regionRadius);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (_redraw)
            {
                ControlPaint.DrawBorder(e.Graphics, base.ClientRectangle, _borderStyleColor, _borderStyleSize, _borderStyleType, _borderStyleColor, _borderStyleSize, _borderStyleType, _borderStyleColor, _borderStyleSize, _borderStyleType, _borderStyleColor, _borderStyleSize, _borderStyleType);
            }
        }
        #endregion
