...
namespace M.Core.Controls
{
    ...
    public partial class UCNumTextBox : UserControl
    {
        ...
        public decimal MaxValue
        {
            get
            {
                return txtNum.MaxValue;
            }
            set
            {
                txtNum.MaxValue = value;
            }
        }
        /// <summary>
        ...
        public decimal MinValue
        {
            get
            {
                return txtNum.MinValue;
            }
            set
            {
                txtNum.MinValue = value;
            }
        }
        /// <summary>
        /// The key board type
        ...
        public decimal Num
        {
            get { return txtNum.Text.ToDecimal().Value; }
        ...
        private void btnAdd_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            decimal dec = txtNum.Text.ToDecimal().Value;
            dec += increment;
        ...
        {
            txtNum.Location = new Point(txtNum.Location.X, (Height - txtNum.Height) / 2);
        }
