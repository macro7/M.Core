namespace M.Core.Controls
{
    /// <summary>
    /// Class UCDropDownBtn.
    /// Implements the <see cref="M.Core.Controls.UCButtonImage" />
    /// </summary>
    /// <seealso cref="M.Core.Controls.UCButtonImage" />
    partial class UCDropDownButton
    {
        /// <summary>
        /// 必需的设计器变量。
        /// </summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(UCDropDownButton));
            this.SuspendLayout();
            // 
            // lbl
            // 
