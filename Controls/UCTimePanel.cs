...
namespace M.Core.Controls
{
    ...
    public partial class UCTimePanel : UserControl
    {
        ...
        {
            InitializeComponent();
            SizeChanged += UCTimePanel_SizeChanged;
        }
        ...
        public void SetSource(List<KeyValuePair<string, string>> lstSource)
        {
            try
            {
                ...
                int index = 0;
                SelectBtn = null;
                foreach (UCButton btn in panMain.Controls)
                {
        ...
        {
            foreach (UCButton item in panMain.Controls)
            {
        ...
        public void ReloadPanel()
        {
            ...
            panMain.ColumnCount = column;
            panMain.ColumnStyles.Clear();
            for (int i = 0; i < column; i++)
            {
                panMain.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 50F));
            }

            panMain.RowCount = row;
            panMain.RowStyles.Clear();
            for (int i = 0; i < row; i++)
            {
                panMain.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 50F));
            }
