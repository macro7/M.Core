...
namespace M.Core.Controls
{
    ...
    /// Implements the <see cref="TextBoxEx" />
    /// </summary>
    /// <seealso cref="TextBoxEx" />
    public class TextBoxTransparent : TextBoxEx
    {
        ...
        protected override void OnGotFocus(EventArgs e)
        {
            ...
            myTimer1 = new System.Windows.Forms.Timer(components);
        ...
        protected override void WndProc(ref Message m)
        {
            ...
            if (m.Msg == win32.WM_PAINT)
            {
                ...
                if (string.IsNullOrEmpty(Text) && !string.IsNullOrEmpty(PromptText))
                {
                    ...
                    SizeF sizet1 = g.MeasureString(PromptText, PromptFont);
                    g.DrawString(PromptText, PromptFont, new SolidBrush(PromptColor), new PointF(3, (bit.Height - sizet1.Height) / 2));
                    g.Dispose();
