    ...
    public partial class UCHorizontalList : UserControl
    {
        ...
        public void ReloadSource()
        {
            try
            {
                ...
                m_startItemIndex = 0;
                if (panList.Width > panMain.Width)
                {
                ...
                {
                    SelectItem((UCHorizontalListItem)panList.Controls[0]);
                }
            }
            finally
            {
        ...
        private void panLeft_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            {
                if (panList.Controls[i].Location.X < panList.Controls[m_startItemIndex].Location.X - panMain.Width)
                {
        ...
        private void panRight_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            for (int i = m_startItemIndex; i < panList.Controls.Count; i++)
            {
                if (panList.Location.X + panList.Controls[i].Location.X + panList.Controls[i].Width > panMain.Width)
                {
                    m_startItemIndex = i;
                    break;
                }
        ...
        private void ResetListLocation()
        {
            if (panList.Controls.Count > 0)
            {
                panList.Location = new Point(panList.Controls[m_startItemIndex].Location.X * -1, 0);
            }
        }
        ...
        {
            foreach (UCHorizontalListItem item in panList.Controls)
            {
