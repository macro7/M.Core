    ...
    public partial class UCCombox : UCControlBase
    {
        ...
        public new Font Font
        {
            ...
            set
            {
                ...
                lblInput.Location = new Point(lblInput.Location.X, (Height - lblInput.Height) / 2);
            }
        }
            ...
            if (_frmAnchor == null || _frmAnchor.IsDisposed || _frmAnchor.Visible == false)
            {
                ...
                if (Source != null && Source.Count > 0)
                {
                    ...
                    while (true)
                    {
                        ...
                        if ((p.Y + Height + Source.Count / intCom * 50 < intScreenHeight || p.Y - Source.Count / intCom * 50 > 0)
                            && (_dropPanelHeight <= 0 ? true : (Source.Count / intCom * 50 <= _dropPanelHeight)))
                        {
