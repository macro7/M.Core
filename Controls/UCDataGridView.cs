    ...
    public partial class UCDataGridView : UserControl
    {
        ...
        public int HeadPadingLeft
        {
            ...
            set
            {
                ...
                panHeadLeft.Width = m_headPadingLeft;
            }
        }
        ...
        public bool AutoRowsScroll
        {
            get
            {
                return panRow.AutoScroll;
            }
            set
            {
                panRow.AutoScroll = value;
            }
        }
            ...
            try
            {
                ...
                if (m_columns != null && m_columns.Count() > 0)
                {
                    ...
                    for (int i = 0; i < intColumnsCount; i++)
                    {
                        ...
                        {
                            panColumns.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(SizeType.Absolute, 30F));
                        ...
                        else
                        {
                            ...
                            panColumns.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(item.WidthType, item.Width));
                            Label lbl = new Label();
        ...
        public void ResetShowCount()
        {
            ...
            ShowCount = panRow.Height / (m_rowHeight);
            if (ShowCount == 0)
            {
                return;
            }

            int intCha = panRow.Height % (m_rowHeight);
        ...
        public void ReloadSource()
        {
            ...
            try
            {
                ...
                if (m_dataSource != null)
                {
                    ...
                    {
                        lastItem.Height = panRow.Height - (m_showCount - 1) * m_rowHeight - 2;
                    }
                }
                else
                {
            ...
            try
            {
                ...
                if (m_selectRow != item)
                {
                    ...
                    if (panRow.Controls.Count > 0)
                    {
                        ...
                        else if (item.Location.Y + m_rowHeight > panRow.Height)
                        {
                            panRow.AutoScrollPosition = new Point(0, Math.Abs(panRow.AutoScrollPosition.Y) + item.Location.Y - panRow.Height + m_rowHeight);
                        }
                    }
                }
